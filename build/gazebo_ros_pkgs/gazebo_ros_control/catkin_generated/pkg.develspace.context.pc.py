...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspaces/Kinematics_ws/src/gazebo_ros_pkgs/gazebo_ros_control/include".split(';') if "/workspaces/Kinematics_ws/src/gazebo_ros_pkgs/gazebo_ros_control/include" != "" else []
