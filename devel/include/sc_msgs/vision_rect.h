...
bool operator==(const ::sc_msgs::vision_rect_<ContainerAllocator1> & lhs, const ::sc_msgs::vision_rect_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.topleft_x == rhs.topleft_x &&
    lhs.topleft_y == rhs.topleft_y &&
    lhs.bottomright_x == rhs.bottomright_x &&
    lhs.bottomright_y == rhs.bottomright_y;
}
